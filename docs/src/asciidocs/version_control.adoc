...
Before you begin, check for the following prerequisites:
...
+
Make sure the access token has `repo` scope that grants full access to public and private repositories,  commit and deployment status, repository invitations, and security events.
